...
public class MariaDBBackgroundJobContainer extends AbstractBackgroundJobSqlContainer {

    public MariaDBBackgroundJobContainer(JdbcDatabaseContainer sqlContainer, Network network) {
        super("jobrunr-e2e-mariadb:1.0", sqlContainer, network);
    }
