...
public class MariaDbJacksonBackgroundJobContainer extends AbstractBackgroundJobSqlContainer {

    public MariaDbJacksonBackgroundJobContainer(JdbcDatabaseContainer sqlContainer) {
