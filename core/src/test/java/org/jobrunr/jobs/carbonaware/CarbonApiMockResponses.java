...
public class CarbonApiMockResponses {
    ...
    public static final String MISSING_UNIT_FIELD = contentOfResource("/carbonaware/api/missing_unit_field.json");
    ...
    public static final String BELGIUM_TODAY = contentOfResource("/carbonaware/api/belgium_tomorrow.json").replace("%s", LocalDate.now(ZoneId.of("UTC")).toString());
