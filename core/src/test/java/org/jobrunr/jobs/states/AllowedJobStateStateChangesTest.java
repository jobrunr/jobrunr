...
class AllowedJobStateStateChangesTest {
    ...
    void testAllowedStatesFromProcessing() {
        ...
        assertThat(isIllegalStateChange(PROCESSING, AWAITING)).isTrue();
    ...
    void testAllowedStatesFromSucceeded() {
        ...
        assertThat(isIllegalStateChange(SUCCEEDED, AWAITING)).isTrue();
    ...
    void testAllowedStatesFromFailed() {
        ...
        assertThat(isIllegalStateChange(FAILED, AWAITING)).isTrue();
    ...
    void testAllowedStatesFromDeleted() {
        ...
        assertThat(isIllegalStateChange(DELETED, AWAITING)).isTrue();
