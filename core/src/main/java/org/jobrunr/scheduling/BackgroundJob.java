...
public class BackgroundJob {
    ...
    /**
     * Creates a new or alters the existing recurring job based on the given {@link RecurringJobBuilder} The first run of this recurring job will happen after the given duration unless your duration is smaller or equal than your backgroundJobServer pollInterval.
     * <h5>An example:</h5>
     * <pre>{@code
     *      RecurringJobBuilder myBuilder = RecurringJobBuilder.aRecurringJob();
     *      //set fields of the builder
     *
     *      BackgroundJob.<MyService>scheduleRecurrently(recurringJobBuilder);
     * }</pre>
     *
